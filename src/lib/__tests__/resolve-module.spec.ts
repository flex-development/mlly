 ...
 * @module mlly/lib/tests/resolveModule/unit
 */
...
describe('unit:lib/resolveModule', () => {
  describe('resolve', () => {
    ...
    it('should resolve file url', async () => {
      // Arrange
      const specifier = pathToFileURL('src/lib/to-absolute-specifier.ts').href
    ...
    it('should resolve file url as directory index w/o /index*', async () => {
      // Arrange
      const specifier = pathToFileURL('src/lib')
    ...
    it('should resolve file url w/o extension', async () => {
      // Arrange
      const specifier = pathToFileURL('src/lib/to-bare-specifier')
    ...
    it('should resolve module w/o extension', async () => {
      // Arrange
      const expected = pathToFileURL('src/lib/to-relative-specifier.ts').href
