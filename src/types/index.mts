...
export type { default as ExtensionRewrites } from '#types/extension-rewrites'
export type { default as FileContent } from '#types/file-content'
export type { default as GetNewExtension } from '#types/get-new-extension'
...
export type {
  default as PatternKeyComparison
} from '#types/pattern-key-comparison'
